...
import link from "next/link"
import { SiCss3, SiTypescript, SiVisualstudiocode, SiVisualstudioappcenter } from "react-icons/si";
import { FaPython, FaGithubAlt } from "react-icons/fa6";
...
/>   </h1>
      <p className="text-base  text-white leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">Explore the essential features of each TypeScript project and easily run them using the npx commands provided below:</p>
    </div>
    <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-100 rounded flex p-4 h-full items-center hover:bg-red-200"> 
      ...
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-100 rounded flex p-4 h-full items-center hover:bg-red-200 ">
          ...
          <span className="title-font font-medium">npx run start:number-guessing-game</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-100 rounded flex p-4 h-full items-center hover:bg-red-200 ">
    ...
    <a href = "   https://github.com/muskanBP">
    <button className="flex mx-auto mt-16 text-white bg-pink-500 border-0 py-2 px-8 focus:outline-none hover:bg-pink-600 rounded text-lg">Visit My GitHub Account</button>
  </a>
  </div>
</section>


{ /*last button after github*/}
<section className="text-gray-600  text-small body-font">
  <div className="container px-5 py-24 mx-auto flex items-center md:flex-row flex-col">
    <div className="flex flex-col md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
      <h2 className="text-xs text-pink-500 tracking-widest font-medium title-font mb-1">about life structure</h2>
      <h6 className="text-small  font-medium title-font text-gray-900"> One of my favorites is from Maya Angelou: “You will face many defeats in life,<br></br> but never let yourself be defeated.” It’s a powerful reminder about resilience!  </h6>
    </div>
    <div className="flex md:ml-auto md:mr-0 mx-auto items-center flex-shrink-0 space-x-4">
      ...
      <img className =" w-15 h-10 "src =" https://github.githubassets.com/assets/GitHub-Mark-ea2971cee799.png"/>
        <span className="ml-4 flex items-start flex-col leading-none">
        <a href = " https://github.com/muskanBP ">
          <span className="text-xs text-black  mb-1 ">Github</span>
          <span className="title-font text-black font-medium ">Nikki</span>
          </a>
          </span>
      </button>
...
<section>
  <div className="container px-5 py-8 mx-auto flex flex-col items-center">
    ...
    <div className="flex flex-wrap justify-center gap-6 mb-8">
      {/* HTML Icon */}
      <div className="flex flex-col items-center bg-gray-200 border-2 border-blue-600 p-4 transition-transform duration-300 ease-in-out transform hover:scale-110 w-40 rounded-lg">
        <FaHtml5 className="text-blue-600 text-6xl" />
        <span className="mt-2 text-lg text-gray-800">HTML</span>
      </div>

      {/* JavaScript Icon */}
      <div className="flex flex-col items-center bg-gray-200 border-2 border-blue-600 p-4 transition-transform duration-300 ease-in-out transform hover:scale-110 w-40 rounded-lg">
        <TbBrandJavascript className="text-yellow-600 text-6xl" />
        <span className="mt-2 text-lg text-gray-800">JAVASCRIPT</span>
      </div>

      {/* CSS Icon */}
      <div className="flex flex-col items-center bg-gray-200 border-2 border-blue-600 p-4 transition-transform duration-300 ease-in-out transform hover:scale-110 w-40 rounded-lg">
        <SiCss3 className="text-sky-600 text-6xl" />
        <span className="mt-2 text-lg text-gray-800">CSS</span>
      </div>
    ...
    <div className="flex flex-wrap justify-center gap-6 mb-8">
      ...
      <div className="flex flex-col items-center bg-gray-200 border-2 border-blue-600 p-4 transition-transform duration-300 ease-in-out transform hover:scale-110 w-40 rounded-lg">
        ...
        <span className="mt-2 text-lg text-gray-800">TYPESCRIPT</span>
      </div>

      {/* Python Icon */}
      <div className="flex flex-col items-center bg-gray-200 border-2 border-blue-600 p-4 transition-transform duration-300 ease-in-out transform hover:scale-110 w-40 rounded-lg">
        <FaPython className="text-purple-500 text-6xl" />
        <span className="mt-2 text-lg text-gray-800">PYTHON</span>
      </div>
  
    </div>

    {/* Title for Development Tools */}
    <h1 className="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 my-10">
      <Typewriter
        options={{
    ...
    {/* Icons Row 3 */}
    <div className="flex flex-wrap justify-center gap-6 mb-8 mt-1">
      {/* Visual Studio Code Icon */}
      <div className="flex flex-col items-center bg-gray-300 border-2 border-blue-600 p-4 transition-transform duration-300 ease-in-out transform hover:scale-110 w-40 rounded-lg">
        <SiVisualstudiocode className="text-sky-600 text-6xl" />
        <span className="mt-2 text-lg text-gray-800">VS CODE</span>
        
      </div>
      <h1 className=" sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mt-20">
      <Typewriter
        options={{
          strings: ["..."],
          autoStart: true,
      ...
      {/* GitHub Icon */}
      <div className="flex flex-col items-center bg-gray-200 border-2 border-blue-600 p-4 transition-transform duration-300 ease-in-out transform hover:scale-110 w-40 rounded-lg">
        <FaGithubAlt className="text-blue-600 text-6xl" />
        <span className="mt-2 text-lg text-gray-800">GITHUB</span>
      </div>

      {/* Visual Studio Icon */}
      <div className="flex flex-col items-center bg-gray-200 border-2 border-blue-600 p-4 transition-transform duration-300 ease-in-out transform hover:scale-110 w-40 rounded-lg">
        <SiVisualstudioappcenter className="text-red-800 text-6xl" />
        <span className="mt-2 text-lg text-gray-800">VISUAL STUDIO</span>
      </div>
    </div>

    {/* Project & Commands Title */}
    <h1 className=" sm:text-3xl mb-3 text-2xl font-medium text-center title-font text-gray-900 mt-20">
      <Typewriter
        options={{
          strings: ["PROJECT & COMMANDS"],
          autoStart: true,
          loop: true,
        }}
      />
