...
<motion.div
  className="h-screen w-full flex items-center justify-center bg-gradient-to-r from-purple-500 to-pink-500 text-center rounded-full" // Make it a big circle with a gradient background
  initial={{ opacity: 0 }}
  animate={{ opacity: 1 }}
  transition={{ duration: 1 }}
>
  <div className="flex flex-col items-center justify-center p-8 rounded-full bg-white bg-opacity-20 shadow-2xl"> {/* Inner circle with subtle transparency */}
    <motion.h1 
      className="text-6xl font-extrabold text-white mb-4" // Large font size with bold text
      variants={fadeInUp} 
      initial="hidden" 
      animate="visible"
    >
...
<span className="ml-3 text-3xl font-semibold text-gradient bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600">Butterfly</span>
